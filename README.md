...
This is a clone project of the popular word guessing game we all know and love. It has been edited to only allow one guess for use in teamwork activities. Made using React, Typescript, and Tailwind.
